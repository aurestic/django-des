...
class DynamicEmailConfiguration(SingletonModel):
    host = models.CharField(
        blank=True, null=True, max_length=256, verbose_name="Email Host"
    )

    port = models.SmallIntegerField(blank=True, null=True, verbose_name="Email Port")

    from_email = models.CharField(
        blank=True, null=True, max_length=256, verbose_name="Default From Email"
    )
    ...
    timeout = models.SmallIntegerField(
        blank=True, null=True, verbose_name="Email Send Timeout (seconds)"
    )
