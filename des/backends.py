    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ConfiguredEmailBackend, self).__init__(
            ...
            # TODO: configuration.ssl_keyfile if ssl_keyfile is not None else ssl_keyfile,
            ssl_keyfile=ssl_keyfile,
            # TODO: configuration.ssl_certfile if ssl_certfile is not None else ssl_certfile,
